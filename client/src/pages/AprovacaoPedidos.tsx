    ...
    <div className="px-4 pb-4" onClick={e => e.stopPropagation()}>
      <div className="flex flex-col gap-3">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3">
          ...
          {/* Card 4: Risco Hoje */}
          <div className={`rounded-lg border p-3 ${currentData.skusCriticosHoje > 0 ? 'bg-rose-50 border-rose-200 dark:bg-rose-950/30 dark:border-rose-800' : 'bg-card border-border'}`} title="SKUs críticos HOJE">
            <div className="flex items-center gap-2 mb-1.5">
